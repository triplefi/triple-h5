        ...
        initDatafeed() {
            ...
            this.tvWidget = new TradingView.widget({
                ...
                enabled_features: this.chartParams.showLeftBar
                    ? ['move_logo_to_main_pane', 'keep_left_toolbar_visible_on_small_screens']
                ...
                overrides: {
                    ...
                    'paneProperties.vertGridProperties.color': this.themeOptions.vertGridColor, // 网格线颜色垂直方向
                    'paneProperties.vertGridProperties.style': 0,
                    'paneProperties.horzGridProperties.color': this.themeOptions.horzGridColor, // 网格线颜色水平方向
                    'paneProperties.horzGridProperties.style': 0,
                    'paneProperties.topMargin': 12,
                    'paneProperties.bottomMargin': 5,
                    'paneProperties.crossHairProperties.color': this.themeOptions.crossHairColor, // 十字线
                    ...
                    'mainSeriesProperties.candleStyle.downColor': this.themeOptions.downColor, // 阴线背景色
                    ...
                    'mainSeriesProperties.candleStyle.borderUpColor': this.themeOptions.upColor, // 阳线边框色
                    'mainSeriesProperties.candleStyle.borderDownColor': this.themeOptions.downColor, // 阴线边框色
                    'mainSeriesProperties.candleStyle.wickUpColor': this.themeOptions.wickUpColor, // 上影线颜色
                    'mainSeriesProperties.candleStyle.wickDownColor': this.themeOptions.wickDownColor, // 下影线颜色
        ...
        themeOptions: {
            handler(curVal, oldVal) {
                ...
                this.tvWidget.applyOverrides({
                    ...
                    'mainSeriesProperties.candleStyle.borderUpColor': curVal.borderUpColor, // 阳线边框色
                    ...
                    'mainSeriesProperties.candleStyle.wickDownColor': curVal.wickDownColor // 下影线颜色
                })
